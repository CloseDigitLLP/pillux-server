  ...
  class planning_secretarys extends Model {
    ...
    static associate(models) {
      // define association here
          ...
          planning_secretarys.hasMany(models.student_payment,{foreignKey:"secretary_id",as:"secretaryStudentPayment",onDelete: "CASCADE", onUpdate: "CASCADE"})
          planning_secretarys.hasMany(models.student_formula,{foreignKey:"secretary_id",as:"secretaryStudentFormula",onDelete: "CASCADE", onUpdate: "CASCADE"})
